...
if ! command -v colmap &> /dev/null; then
    ...
    apt-get install -y colmap || {
        ...
        echo "  Building COLMAP from source with CUDA (strict sequence)..."
        # BEGIN: Strict COLMAP source install sequence
        ...
        sudo ninja install
        cd /workspace
        # END: Strict COLMAP source install sequence
    }
else
...
echo "  1. Process: python3 scripts/01_extract_and_map.py /videos -o dataset/ --resize 1280 720"
